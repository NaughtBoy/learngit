...
public class OldCard extends LinearLayout implements OnClickListener {
	...
	public OldCard(Context context) {
		super(context);
	 ...
	 *            lostData
	 */
	public void setData(OldData data) {
		this.mData = data;
		mNameView.setText(data.mName + "（￥ " + data.mPrice + "）");
